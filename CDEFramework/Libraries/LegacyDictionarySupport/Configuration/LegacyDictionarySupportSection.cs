...
{
    /// <summary>
    /// LegacyDictionarySupport configuration information
    /// </summary>
    public class LegacyDictionarySupportSection : ConfigurationSection
    {
        private static readonly string CONFIG_SECTION_NAME = "legacyServices/legacyDictionarySupport";
        ...
        {
            string loc = "";
        LegacyDictionarySupportSection config = (LegacyDictionarySupportSection)ConfigurationManager.GetSection(CONFIG_SECTION_NAME);
