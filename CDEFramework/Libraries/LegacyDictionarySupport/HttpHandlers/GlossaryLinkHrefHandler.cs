            ...
            switch (termDictionary.ToLower())
            {
                case "cancer.gov":
                    ...
                    if (audience.ToLower() == "patient")
                    {
                        ...
                        {
                            return LegacyDictionarySupportSection.GetEnglishTermDictionaryUrl();
                        }

                        if (termLanguage.ToLower() == "es")
                        {
                            return LegacyDictionarySupportSection.GetSpanishTermDictionaryUrl();
                        }
                    }
                ...
                case "genetics":
                    ...
                    {
                        return LegacyDictionarySupportSection.GetEnglishGeneticsDictionaryUrl();
                    }
