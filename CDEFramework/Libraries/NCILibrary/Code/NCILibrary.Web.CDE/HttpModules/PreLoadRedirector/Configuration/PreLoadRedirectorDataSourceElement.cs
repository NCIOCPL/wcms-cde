...
{
    public class PreLoadRedirectorDataSourceElement : ConfigurationElement
    {
        const String DEFAULT_FILE_LOCATION = "~/PublishedContent/Files/Configuration/PreLoadRedirectionList.txt";
